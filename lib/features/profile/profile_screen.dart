      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(children: [
              Text(
                  ...
                  style: condensed(
                      size: 52, weight: FontWeight.w700, color: tungsten)),
          ...
          Row(children: [
            ...
            const SizedBox(width: 12),
            _Stat(
                value: '$seriesInProgress', label: l10n.statShowsInProgress),
          ]),
          ...
          if (topShow != null && topShow.watchedEpisodes > 0) ...[
            ...
            Text(l10n.episodeCount(topShow.watchedEpisodes),
          ...
          OutlinedButton.icon(
            style: OutlinedButton.styleFrom(
              ...
              side:
                  BorderSide(color: const Color(0xFFE07A6B).withValues(alpha: .5)),
    ...
    return Row(children: [
      ...
      Expanded(
        child: Column(
          ...
          children: [
            Text(name ?? AppLocalizations.of(context).you,
